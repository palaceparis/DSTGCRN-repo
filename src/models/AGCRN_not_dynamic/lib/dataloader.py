...
def get_dataloader(args, normalizer="std", single=True):
    ...
    # normalize st data
    data_train[:, :, :3], scaler = normalize_dataset(
        data_train[:, :, :3], normalizer, args.column_wise
    )
    data_val[:, :, :3], _ = normalize_dataset(
        data_val[:, :, :3], normalizer, args.column_wise
    )
    data_test[:, :, :3], _ = normalize_dataset(
        data_test[:, :, :3], normalizer, args.column_wise
    )
